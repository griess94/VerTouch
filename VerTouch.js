...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		self.BK.addEventListener("click",BKclick )
		function BKclick(){
			chabgTocolor()
			Nounderline()
		}
	...
	// code
	this.text = new cjs.Text("...לקבת טעמים נוספים", "normal 700 32px 'Assistant'", "#FFFFFF");
	this.text.textAlign = "center";
	this.text.lineHeight = 44;
	this.text.lineWidth = 291;
	this.text.parent = this;
	this.text.setTransform(1099.1,37.7);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text);
	}

	this.text_1 = new cjs.Text("לחץ על תערובות ", "normal 700 32px 'Assistant'", "#FFFFFF");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 44;
	this.text_1.lineWidth = 229;
	this.text_1.parent = this;
	this.text_1.setTransform(1496.05,38.4);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_1);
	}
	...
	this.or21.name = "or21";
	this.or21.setTransform(1369.75,727.2,0.3184,0.3248,0,0,0,187.7,160.6);

	this.or20 = new lib.shenghay();
	this.or20.name = "or20";
	this.or20.setTransform(1483.65,727.2,0.3184,0.3248,0,0,0,187.5,160.6);

	this.or16 = new lib.vina();
	this.or16.name = "or16";
	this.or16.setTransform(1590.35,727.25,0.3184,0.3248,0,0,0,187.7,160.8);

	this.or13 = new lib.tokyo();
	this.or13.name = "or13";
	this.or13.setTransform(1369.75,637.4,0.3184,0.3248,0,0,0,187.7,160.8);

	this.or15 = new lib.stokholm();
	this.or15.name = "or15";
	this.or15.setTransform(1481.7,635.55,0.3184,0.3248,0,0,0,187.7,160.6);

	this.or14 = new lib.capetune();
	this.or14.name = "or14";
	this.or14.setTransform(1590.35,634.35,0.3184,0.3248,0,0,0,187.7,160.6);

	this.or19 = new lib.cosi();
	this.or19.name = "or19";
	this.or19.setTransform(1369.75,814.65,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or17 = new lib.forti();
	this.or17.name = "or17";
	this.or17.setTransform(1590.35,812.55,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or9 = new lib.indo();
	this.or9.name = "or9";
	this.or9.setTransform(1369.75,425.8,0.7709,0.7709,0,0,0,77.5,67.6);

	this.or11 = new lib.Onik();
	this.or11.name = "or11";
	this.or11.setTransform(1481.7,531.05,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or8 = new lib.india();
	this.or8.name = "or8";
	this.or8.setTransform(1481.7,425.35,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or12 = new lib.Oety();
	this.or12.name = "or12";
	this.or12.setTransform(1369.75,533.15,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or10 = new lib.Ocolo();
	this.or10.name = "or10";
	this.or10.setTransform(1590.35,530.15,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or18 = new lib.voloto();
	this.or18.name = "or18";
	this.or18.setTransform(1483.7,812.55,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or7 = new lib.livanto_1();
	this.or7.name = "or7";
	this.or7.setTransform(1530.6,371.6,0.7709,0.7709);

	this.or5 = new lib.roma();
	this.or5.name = "or5";
	this.or5.setTransform(1481.7,314.7,0.7709,0.7709,0,0,0,77.5,67.6);

	this.or2 = new lib.kazr();
	this.or2.name = "or2";
	this.or2.setTransform(1481.7,210.55,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or4 = new lib.arpjo();
	this.or4.name = "or4";
	this.or4.setTransform(1590.35,314.7,0.7709,0.7709,0,0,0,77.5,67.6);

	this.or3 = new lib.rist();
	this.or3.name = "or3";
	this.or3.setTransform(1369.75,210.55,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or1 = new lib.napoli();
	this.or1.name = "or1";
	this.or1.setTransform(1590.35,210.55,0.7709,0.7709,0,0,0,77.5,67.7);

	this.or6 = new lib.venzia();
	this.or6.name = "or6";
	this.or6.setTransform(1369.75,314.7,0.7709,0.7709,0,0,0,77.5,67.6);
	...
	this.con9.name = "con9";
	this.con9.setTransform(1195.65,590.95,1,1,0,0,0,105.2,27.4);

	this.con4 = new lib.con4();
	this.con4.name = "con4";
	this.con4.setTransform(1225.5,360.7,1,1,0,0,0,75.4,27.4);

	this.con8 = new lib.con8();
	this.con8.name = "con8";
	this.con8.setTransform(1205.45,821.5,1,1,0,0,0,95.4,27.4);

	this.con7 = new lib.con7();
	this.con7.name = "con7";
	this.con7.setTransform(1211.55,744.45,1,1,0,0,0,89.2,27.4);

	this.con6 = new lib.con6();
	this.con6.name = "con6";
	this.con6.setTransform(1244.3,283.95,1,1,0,0,0,56.5,27.4);

	this.con5 = new lib.con5();
	this.con5.name = "con5";
	this.con5.setTransform(1225.5,207.1,1,1,0,0,0,75.4,27.4);

	this.con3 = new lib.con3();
	this.con3.name = "con3";
	this.con3.setTransform(1209.65,667.65,1,1,0,0,0,91,27.4);

	this.con2 = new lib.con2();
	this.con2.name = "con2";
	this.con2.setTransform(1185.15,514.2,1,1,0,0,0,115.6,27.4);

	this.con1 = new lib.con1();
	this.con1.name = "con1";
	this.con1.setTransform(1220.1,437.45,1,1,0,0,0,80.7,27.4);

	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#000000").ss(1,1,1).p("EAAAg87IAAAIEAAAgz0MAAABww");
	this.shape.setTransform(1310,490.8);
	...
	// cupsuol
	this.text_2 = new cjs.Text("ORIGINAL", "normal 700 32px 'Assistant'", "#FFFFFF");
	this.text_2.textAlign = "center";
	this.text_2.lineHeight = 44;
	this.text_2.lineWidth = 141;
	this.text_2.parent = this;
	this.text_2.setTransform(1473.85,112);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_2);
	}

	this.text_3 = new cjs.Text("150 מ\"ל", "normal 700 20px 'Assistant'", "#FFFFFF");
	this.text_3.textAlign = "center";
	this.text_3.lineHeight = 28;
	this.text_3.lineWidth = 110;
	this.text_3.parent = this;
	this.text_3.setTransform(444.7,424.55);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_3);
	}

	this.text_4 = new cjs.Text("80 מ\"ל", "normal 700 20px 'Assistant'", "#FFFFFF");
	this.text_4.textAlign = "center";
	this.text_4.lineHeight = 28;
	this.text_4.lineWidth = 110;
	this.text_4.parent = this;
	this.text_4.setTransform(419.95,590.85);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_4);
	}

	this.text_5 = new cjs.Text("40 מ\"ל", "normal 700 20px 'Assistant'", "#FFFFFF");
	this.text_5.textAlign = "center";
	this.text_5.lineHeight = 28;
	this.text_5.lineWidth = 110;
	this.text_5.parent = this;
	this.text_5.setTransform(454.15,744.8);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_5);
	}

	this.text_6 = new cjs.Text("אלטו מאג", "normal 700 40px 'Assistant'", "#FFFFFF");
	this.text_6.textAlign = "center";
	this.text_6.lineHeight = 54;
	this.text_6.lineWidth = 240;
	this.text_6.parent = this;
	this.text_6.setTransform(567,40.2);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_6);
	}

	this.text_7 = new cjs.Text("מאג", "normal 700 40px 'Assistant'", "#FFFFFF");
	this.text_7.textAlign = "center";
	this.text_7.lineHeight = 54;
	this.text_7.lineWidth = 240;
	this.text_7.parent = this;
	this.text_7.setTransform(565.3,169.4);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_7);
	}

	this.text_8 = new cjs.Text("גראן לונגו", "normal 700 40px 'Assistant'", "#FFFFFF");
	this.text_8.textAlign = "center";
	this.text_8.lineHeight = 54;
	this.text_8.lineWidth = 240;
	this.text_8.parent = this;
	this.text_8.setTransform(565.3,408.3);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_8);
	}

	this.text_9 = new cjs.Text("דאבל אספרסו", "normal 700 40px 'Assistant'", "#FFFFFF");
	this.text_9.textAlign = "center";
	this.text_9.lineHeight = 54;
	this.text_9.lineWidth = 240;
	this.text_9.parent = this;
	this.text_9.setTransform(565.3,575.5);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_9);
	}

	this.text_10 = new cjs.Text("אספרסו", "normal 700 40px 'Assistant'", "#FFFFFF");
	this.text_10.textAlign = "center";
	this.text_10.lineHeight = 54;
	this.text_10.lineWidth = 139;
	this.text_10.parent = this;
	this.text_10.setTransform(556.25,729.4);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
	...
	this.ES1.name = "ES1";
	this.ES1.setTransform(632.7,808,0.7854,0.7986,0,0,0,96.9,55.1);

	this.ALTO1 = new lib.alto_dolche();
	this.ALTO1.name = "ALTO1";
	this.ALTO1.setTransform(638.3,128.9,0.7415,0.6861,0,0,0,100.2,61.3);

	this.ALTO2 = new lib.alto();
	this.ALTO2.name = "ALTO2";
	this.ALTO2.setTransform(416,86.95,0.388,0.3517);

	this.longo3 = new lib.arondio();
	this.longo3.name = "longo3";
	this.longo3.setTransform(282.4,515.7,0.388,0.3518,0,0,0,192.2,120);

	this.longo2 = new lib.fortado();
	this.longo2.name = "longo2";
	this.longo2.setTransform(422.2,515.7,0.388,0.3518,0,0,0,192.1,120);

	this.longo1 = new lib.decaff150();
	this.longo1.name = "longo1";
	this.longo1.setTransform(841.15,515.05,0.3879,0.357,0,0,0,191.9,120);

	this.duobel2 = new lib.chiaro();
	this.duobel2.name = "duobel2";
	this.duobel2.setTransform(418.55,666.85,0.3879,0.3498,0,0,0,192.5,120);

	this.duobel1 = new lib.scoro();
	this.duobel1.name = "duobel1";
	this.duobel1.setTransform(561.15,666.65,0.388,0.3499,0,0,0,192.3,119.9);

	this.BR4 = new lib.forte();
	this.BR4.name = "BR4";
	this.BR4.setTransform(908.55,315.1,0.3879,0.3497);

	this.BR1 = new lib.vanik();
	this.BR1.name = "BR1";
	this.BR1.setTransform(562.6,347.45,0.3963,0.3497,0,0,0,188,160.8);

	this.BR5 = new lib.nets();
	this.BR5.name = "BR5";
	this.BR5.setTransform(841.6,350.45,0.3963,0.3497,0,0,0,187.7,160.4);

	this.BR2 = new lib.carael();
	this.BR2.name = "BR2";
	this.BR2.setTransform(699.2,349.15,0.3963,0.3497,0,0,0,188.2,161);

	this.BR3 = new lib.leggero();
	this.BR3.name = "BR3";
	this.BR3.setTransform(703.75,666.75,0.3879,0.3497,0,0,0,192.1,120);

	this.MUG1 = new lib.intenso();
	this.MUG1.name = "MUG1";
	this.MUG1.setTransform(142,267.5,0.388,0.3517,0,0,0,192.3,119.7);

	this.MUG5 = new lib.elvizo();
	this.MUG5.name = "MUG5";
	this.MUG5.setTransform(703.6,265.6,0.388,0.3517,0,0,0,192.1,120);

	this.MUG3 = new lib.stormio();
	this.MUG3.name = "MUG3";
	this.MUG3.setTransform(278.25,267.1,0.388,0.3517,0,0,0,192,120);

	this.MUG4 = new lib.decaff230();
	this.MUG4.name = "MUG4";
	this.MUG4.setTransform(141.75,352.45,0.388,0.3517,0,0,0,191.6,120.2);

	this.MUG2 = new lib.aodiso();
	this.MUG2.name = "MUG2";
	this.MUG2.setTransform(421.95,266.1,0.388,0.3517,0,0,0,191.8,119.7);

	this.MUG8 = new lib.jorjono();
	this.MUG8.name = "MUG8";
	this.MUG8.setTransform(842.75,266.4,0.388,0.3517,0,0,0,192.1,119.7);

	this.MUG7 = new lib.sollu();
	this.MUG7.name = "MUG7";
	this.MUG7.setTransform(983.15,266,0.388,0.3517,0,0,0,192,120.2);

	this.MUG6 = new lib.melozio();
	this.MUG6.name = "MUG6";
	this.MUG6.setTransform(563,266.8,0.388,0.3517,0,0,0,192,120);

	this.ES4 = new lib.natol40();
	this.ES4.name = "ES4";
	this.ES4.setTransform(773.3,808.3,0.7854,0.7988,0,0,0,94.9,55.4);

	this.ES3 = new lib.altiso();
	this.ES3.name = "ES3";
	this.ES3.setTransform(491.25,808.5,0.7854,0.7988,0,0,0,94.9,55.4);

	this.ES2 = new lib.diavolito();
	this.ES2.name = "ES2";
	this.ES2.setTransform(349.05,808.15,0.7854,0.7988,0,0,0,94.8,55.4);

	this.MO1 = new lib.colombia();
	this.MO1.name = "MO1";
	this.MO1.setTransform(423.3,353.8,1.1283,1.0975,0,0,0,66,38.4);

	this.MO3 = new lib.costa();
	this.MO3.name = "MO3";
	this.MO3.setTransform(561.8,509.8,1.1524,1.0596,0,0,0,64.5,51.6);

	this.MO2 = new lib.mexico();
	this.MO2.name = "MO2";
	this.MO2.setTransform(282.15,355.2,1.1283,1.0975,0,0,0,66,38.3);

	this.MO4 = new lib.etyopiya();
	this.MO4.name = "MO4";
	this.MO4.setTransform(702.7,509.4,1.1522,1.0596,0,0,0,64.7,51.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.MO4},{t:this.MO2},{t:this.MO3},{t:this.MO1},{t:this.ES2},{t:this.ES3},{t:this.ES4},{t:this.MUG6},{t:this.MUG7},{t:this.MUG8},{t:this.MUG2},{t:this.MUG4},{t:this.MUG3},{t:this.MUG5},{t:this.MUG1},{t:this.BR3},{t:this.BR2},{t:this.BR5},{t:this.BR1},{t:this.BR4},{t:this.duobel1},{t:this.duobel2},{t:this.longo1},{t:this.longo2},{t:this.longo3},{t:this.ALTO2},{t:this.ALTO1},{t:this.ES1},{t:this.text_10},{t:this.text_9},{t:this.text_8},{t:this.text_7},{t:this.text_6},{t:this.text_5},{t:this.text_4},{t:this.text_3},{t:this.text_2}]}).wait(1));

	// blackBG
	this.text_11 = new cjs.Text("ORIGINAL", "normal 700 32px 'Assistant'", "#FFFFFF");
	this.text_11.textAlign = "center";
	this.text_11.lineHeight = 44;
	this.text_11.lineWidth = 136;
	this.text_11.parent = this;
	this.text_11.setTransform(1315.05,38.4);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_11);
	}

	this.text_12 = new cjs.Text("414 מ\"ל", "normal 700 20px 'Assistant'", "#FFFFFF");
	this.text_12.textAlign = "center";
	this.text_12.lineHeight = 28;
	this.text_12.lineWidth = 110;
	this.text_12.parent = this;
	this.text_12.setTransform(440.45,58.8);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_12);
	}

	this.text_13 = new cjs.Text("230 מ\"ל", "normal 700 20px 'Assistant'", "#FFFFFF");
	this.text_13.textAlign = "center";
	this.text_13.lineHeight = 28;
	this.text_13.lineWidth = 110;
	this.text_13.parent = this;
	this.text_13.setTransform(480.2,187.2);
	if(!lib.properties.webfonts['Assistant']) {
		lib.webFontTxtInst['Assistant'] = lib.webFontTxtInst['Assistant'] || [];
		lib.webFontTxtInst['Assistant'].push(this.text_13);
	}

	this.BK = new lib.blackBG("synched",0);
	this.BK.name = "BK";
	this.BK.setTransform(825.7,435.45,0.9971,1.1827,0,0,0,828.5,368.1);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#000000").ss(1,1,1).p("ECBegAnIAABPEiBdAAoIAAhP");
	this.shape_1.setTransform(822.7,729.65);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.BK},{t:this.text_13},{t:this.text_12},{t:this.text_11}]}).wait(1));

	// stageBackground
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("rgba(0,0,0,0)").ss(1,1,1,3,true).p("EiCdhFhMEE7AAAMAAACLDMkE7AAAg");
	this.shape_2.setTransform(825,435);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("EiCdBFiMAAAiLDMEE7AAAMAAACLDg");
	this.shape_3.setTransform(825,435);
...
p.nominalBounds = new cjs.Rectangle(814,424,847,457.79999999999995);
// library properties:
lib.properties = {
	...
	webfonts: {},
	manifest: [
		{src:"images/VerTouch_atlas_1.png?1623102627759", id:"VerTouch_atlas_1"},
		{src:"images/VerTouch_atlas_2.png?1623102627760", id:"VerTouch_atlas_2"}
	],
	preloads: []
};
